...
const GIP = () => {
  ...
  const rows = [
    createData('GIPCDO-2025-001', 'ADL-2025-001', 'CDO', 24, 4.0, 'Completed', 3.99),
    createData('GIPCAMIGUIN-2025-001', 'ADL-2025-002', 'CAMIGUIN', 37, 4.3, 'Pending', 4.99),
    createData('GIPMISOR-2025-001', 'ADL-2025-003', 'MISOR', 24, 6.0, 'Completed', 3.79),
    createData('GIPTSSD-2025-001', 'ADL-2025-004', 'TSSD', 67, 4.3, 'Pending', 2.5),
    createData('GIPBUKIDNON-2025-001', 'ADL-2025-005', 'BUKIDNON', 49, 3.9, 'Pending', 1.5),
  ];

  return (
    <div className="gip-container">
      <h1>GIP</h1>
      <TableContainer component={Paper} className="gip-table">
